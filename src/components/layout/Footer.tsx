        ...
        <footer className="bg-gray-800 text-white">
            <div className="container mx-auto px-4 py-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* About Section */}
                    <div>
                        <h3 className="text-xl font-semibold mb-4">IAHR Africa Congress 2026</h3>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/program" className="text-gray-300 hover:text-white transition">Program</Link></li>
                            <li><Link href="/participate" className="text-gray-300 hover:text-white transition">Participate</Link></li>
                            <li><Link href="/sponsorship" className="text-gray-300 hover:text-white transition">Sponsorship</Link></li>
                        </ul>
                    </div>
